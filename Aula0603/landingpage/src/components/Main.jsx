...
export default function Main(){
    return(
        <main>
            ...
            <section id="sobre">
                <h2>Sobre Nós</h2>
                <p>Somos uma academia focada em perda de peso e
                    construção de shapes incríveis, no estilo Mr. Olympia. 
                    Com 2 dias de experiência no mercado, esperamos oferecer 
                    o melhor para nossos clientes. Quer ser um bodybuild? Nós 
                    podemos te ajudar
                </p>
            </section>
